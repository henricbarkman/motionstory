...
En röst från andra sidan, Vega, som bara hör vandraren när vandraren rör sig. Världen och kopplingen till HELD: `stories/glimt/varld.md`. Kapitel väljs på startskärmen (eller `?kapitel=2`):
...
Simulerad genomkörning av båda kapitlen, fyra vandrarprofiler var:
